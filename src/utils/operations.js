import { topUpClientBalance, deductClientBalance, createClient, isClientExist, setLoginClient, getLoginClientUID, getClientByUID, getClientBalance, getPayableAmount } from '../utils/client'
import { getMyDebtSummary, getAllDebtsRecord, processDebtSettlement, getUpdatedDebtRecords, updateDebtRecords, recipientOweToSender, senderOweToRecipient, createDebtRecord, updateDebtAmount, clearDebtRecords } from '../utils/debts'
import { OUTPUT, constructLoginOutputMsg, constructTopUpOutputMsg, constructPaymentOutputMsg } from '../utils/output'
...
export function pay(senderUID, recipientUID, amount) {
    return new Promise((resolve, reject) => {
        // 1. check if client has logged in
